...
/*-----Stream overloading for printing nonograms to the console-----*/

// Defines how to print a row
...
PossibleSolution smartSolve(const CluesList& topClues, const CluesList& sideClues) { throw std::runtime_error("Function not yet implemented"); }
